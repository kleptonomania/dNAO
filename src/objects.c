...
WEAPON(("stake driver", "coiled armature"),
	DMG(D(6)), DMG(D(6)),
	1, 0, MZ_LARGE,  0, 40, 100,  1, S|P,   P_DAGGER, METAL, FALSE, HI_METAL, O_TRAITS(ETRAIT_SECOND|ETRAIT_FOCUS_FIRE|ETRAIT_STOP_THRUST)),  
WEAPON(("jolt lance", "coiled gun-lance"),
	DMG(D(8)), DMG(D(8)),
	1, 0, MZ_LARGE, 0, 40, 100, 1, P, P_DAGGER, METAL, FALSE, HI_METAL, O_TRAITS(ETRAIT_LUNGE|ETRAIT_GRAZE)),
WEAPON(("scalpel"),
	DMG(D(3)), DMG(D(1)),
